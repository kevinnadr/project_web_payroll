<?php
// FILE: backend-api/modules/pegawai/download_pdf_one.php
...
<body>
    <script>
        Swal.fire({
            icon: 'warning',
            title: 'Oops! Belum Digenerate',
            html: 'Slip gaji periode <b>$bulan</b> belum digenerate!<br><br>Silakan kembali ke menu <b>Slip Gaji</b> terlebih dahulu dan klik <b>Generate</b>.',
...
HTML;
    ...
    $pdf->Output('I', 'Slip_Gaji_' . $gaji['nik'] . '.pdf');
